...
namespace Student_Management_Final_proj.Areas.Identity.Pages.Account
{
    ...
    public class RegisterCourseAdminModel : PageModel
    {
        ...
        private Student_Management_Data_Context dataContext;

        public RegisterCourseAdminModel(
            UserManager<IdentityUser> userManager,
            SignInManager<IdentityUser> signInManager,
            ILogger<RegisterModel> logger,
            IEmailSender emailSender,
            Student_Management_IdentityContext context
            )
        {
